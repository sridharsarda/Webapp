...
@PropertySource('file:${SPRING_BOOT_PROPERTIES_DIR}/27.properties')
class SecondaryDataSourceLocalConfig extends SecondaryDataSourceAbstractConfig {
    ...
    SecondaryDataSourceLocalConfig() {
        ...
        assert Files.exists(Paths.get("${dir}/27.properties")),
                "${dir}/27.properties containing externalized datasource properties must exist"
    }
